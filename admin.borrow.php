...
<body> 
	...
	<section id="main-sec">
		...
		<ul>
            ...
            <li><a class="active" href="admin.borrow.php">Borrow a CD</a></li>
		...
		<div class="o-container">
            ...
            <form action="includes/admin_borrow.php" method="POST" enctype="multipart/form-data">
                ...
                <button name="update" type="submit" class="add">Submit</button>
